...
frappe.ui.form.on('Process Identification', {
	validate: function(frm){
	    $.each(cur_frm.doc.risk_table || [], function(i, v){
	        ...
	        frappe.model.set_value(v.doctype, v.name, "ro_type", "Process");
	        frappe.model.set_value(v.doctype, v.name, "ro_source", cur_frm.doc.process_name);
	    });
	}
});
